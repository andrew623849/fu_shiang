...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', rel:"preload",href: '../css/style.css?v=123', containers: 1400, grid: { gutters: 50 } },
			...
			narrower:	{ range: '-840',rel:"preload", href: '../css/style-narrower.css', grid: { collapse: 1 } },
			mobile:		{ range: '-640',rel:"preload", href: '../css/style-mobile.css', containers: '90%', grid: { gutters: 15, collapse: 2 } }
		}
	}, {
		layers: {
			layers: {
