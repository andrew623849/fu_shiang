...
<div class="toothcase-form">
    ...
    <div style="background-color:yellow;">
        <div class="form-group col-sm-6" style="height:99px;"><?= $form->field($model,'material_id')->label("*材料")->dropDownList(ArrayHelper::map($material_info,'id','material'),['style'=>'border:1px solid ;'])?></div> 
